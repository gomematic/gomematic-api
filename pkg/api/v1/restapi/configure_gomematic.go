...
//go:generate gorunpkg github.com/go-swagger/go-swagger/cmd/swagger generate server --target ../../v1 --name Gomematic --spec ../../../../assets/apiv1.yml --exclude-main

func configureFlags(api *operations.GomematicAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.GomematicAPI) http.Handler {
